...
import { ConnectionsPanel } from "./DeviceInfo";
...
export const UserDialog: FC<UserDialogProps> = () => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="2xl">
      ...
      <FormProvider {...form}>
        <ModalContent mx="3" overflow="hidden">
          {/* ── Franchise theme banner ── */}
          <Box
            px={5}
            py={2.5}
            position="relative"
            overflow="hidden"
            style={{ background: currentTheme.modalBannerBg }}
          >
            <Box
              position="absolute"
              inset={0}
              style={{
                ...
                backgroundSize: currentTheme.patternSize,
                opacity: 0.4,
              }}
            />
            <Text
              ...
              position="relative"
              zIndex={1}
              style={{ color: currentTheme.modalBannerTextColor }}
              textShadow={`0 0 12px ${currentTheme.modalBannerTextColor}88`}
            >
              {isEditing ? currentTheme.modalBannerEdit : currentTheme.modalBanner}
            </Text>
          </Box>
          <form onSubmit={form.handleSubmit(submit)}>
            ...
            <ModalBody>
              {/* ── Connections panel (edit mode only) ── */}
              {isEditing && editingUser && (
                <Box mb={4}>
                  ...
                  <ConnectionsPanel username={editingUser.username} />
                </Box>
              )}
              <Grid
                templateColumns={{
                        ...
                        return (
                          <RadioGroup
                            list={[
                              ...
                              {
                                title: "v2box",
                                description: t("userDialog.v2boxDesc"),
                              },
                            ]}
                            disabled={disabled}
                            {...field}
